...
линк простаивает? Обычный IGP не даёт ответа — нужно занижать метрики, что влияет
на весь трафик. SR Policy решает это элегантно: вы сами рисуете маршрут через
нужные точки, и только для выбранного трафика.

Метафора: IGP — Яндекс.Навигатор в режиме “кратчайший”. SR Policy — вы сами
ставите промежуточные точки на карте: “через улицу А, потом через Б, потом к В”.
Навигатор подчиняется, даже если это не кратчайший путь.
