...
Три поведения в человеческих терминах:
- **End (uN)** — “приехал в офис, спроси на ресепшене”. Пакет достиг узла,
  SID обработан, дальше по внутреннему заголовку.
- **End.X (uA)** — “не заходи в офис, сразу иди через турникет налево”.
  Пакет не терминируется на узле, а перебрасывается через конкретный интерфейс.
- **End.DT6 (uDT6)** — “сними верхнюю одежду и зайди в переговорную VRF”.
  Деинкапсуляция внешнего IPv6/SRH и lookup внутреннего пакета в VRF (ЛР11).
