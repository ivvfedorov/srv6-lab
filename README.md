...
# Containerlab — сборка из исходников для macOS
# (официальный install-скрипт поставляет только Linux-бинарники)
export PATH="$HOME/go/bin:$PATH"
go install github.com/srl-labs/containerlab/cmd/containerlab@latest

# Добавьте эту строку в ~/.zshrc, чтобы containerlab был доступен во всех сессиях:
